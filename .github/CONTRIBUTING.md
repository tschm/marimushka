# Contributing to marimograd

This document is a guide to contributing to marimograd
...
## Building marimograd from source

You'll need to build marimograd locally in order to start editing code.

To install marimograd from source, clone the GitHub
...
To contribute to marimograd, send us pull requests.
For those new to contributing, check out GitHub's
[guide](https://help.github.com/articles/using-pull-requests/).

Once you've made your pull request, a member of the marimograd
...
If you'd like to add a new feature to marimograd, please do propose your
...
- Read the marimograd source and enhance the documentation,
  or address TODOs
- Browse the [issue tracker](https://github.com/tschm/marimograd/issues),
...
marimograd tests live in the directory `tests`,
